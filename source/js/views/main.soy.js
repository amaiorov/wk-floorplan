...
template.SeatEditor = function(opt_data, opt_ignored) {
  var output = '<div id="seat-editor"><div class="editing-region"><div class="floor-pane"><div class="floor" data-id="6">';
  ...
  output += '</div><div class="floor" data-id="7">';
  ...
  output += '</div><div class="floor" data-id="8">';
  ...
  output += '</div><div class="split-handle"></div></div><div class="waitlist-pane"><h3>Wait List</h3><div class="waitlist">';
...
template.EmployeeIcon = function(opt_data, opt_ignored) {
  return '<div class="employee-icon"><span class="initials">' + opt_data.initials + '</span></div>';
};
